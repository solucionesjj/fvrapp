...
export class TranslationService {
  ...
  private translations: Record<Language, Translations> = {
    es: {
      ...
      'step3.secondName.title': 'Segundo Nombre',
      ...
      'step5.view': 'Ver PDF',
      'step5.view_without_format': 'Ver PDF sin Formato',
      'step5.view_with_format': 'Ver PDF con Formato',
    ...
    en: {
      ...
      'step3.secondName.title': 'Middle Name',
      ...
      'step5.view': 'View PDF',
      'step5.view_without_format': 'View PDF without Format',
      'step5.view_with_format': 'View PDF with Format',
